...
function ServiceHeader({ screen, step, locale, setLocale, onNavigate, accessibilityOpen, setAccessibilityOpen, tourOpen, setTourOpen, mobileNav, setMobileNav }: { screen: Screen; step: number; locale: Locale; setLocale: (locale: Locale) => void; onNavigate: (target: { screen: Screen; step?: number }) => void; accessibilityOpen: boolean; setAccessibilityOpen: (v: boolean) => void; tourOpen: boolean; setTourOpen: (v: boolean) => void; mobileNav: boolean; setMobileNav: (v: boolean) => void }) {
  ...
  return <header className="service-header">
    <div className="header-primary">
      <button className="brand" onClick={() => onNavigate({ screen: 'start' })} aria-label={copy.brandAria}><span className="emblem">VS</span><span><strong>VyaparSathi</strong><small>{copy.tagline}</small></span></button>
...
const uiCopy: Record<Locale, {
  ...
  bn: {
    header: { tagline: 'স্বাধীন উদ্যোগ সিদ্ধান্ত সহায়তা', brandAria: 'VyaparSathi ওভারভিউতে যান', language: 'ভাষা নির্বাচন করুন', how: 'কীভাবে কাজ করে', accessibility: 'অ্যাক্সেসিবিলিটি', openMenu: 'নেভিগেশন মেনু খুলুন', closeMenu: 'নেভিগেশন মেনু বন্ধ করুন', nav: { overview: 'ওভারভিউ', location: 'অবস্থান', capital: 'মূলধন', business: 'ব্যবসা', market: 'বাজার বিশ্লেষণ', finance: 'অর্থায়ন', report: 'পূর্ণ রিপোর্ট' } },
    landing: { label: 'গ্রামীণ উদ্যোগ সিদ্ধান্ত সহায়তা', title: 'স্থানীয় বাজার বুঝুন। অর্থ পরিকল্পনা করুন। আত্মবিশ্বাসের সঙ্গে শুরু করুন।', text: 'একটি নির্দেশিত পরিষেবায় স্থানীয় বাজার, প্রকল্প অর্থায়ন এবং সরকারি প্রকল্প দেখুন।', start: 'ব্যবসা মূল্যায়ন শুরু করুন', proof: ['অবস্থান', 'ব্যবসা', 'মূলধন', 'সম্ভাব্যতা ও অর্থায়ন'], aboutTitle: 'এটি কী?', aboutText: 'VyaparSathi গ্রামীণ উদ্যোক্তাদের জন্য একটি নির্দেশিত সিদ্ধান্ত-সহায়তা পরিষেবা। এটি অবস্থান, ব্যবসা বিভাগ, অর্থ পরিকল্পনা, পরিশোধ প্রস্তুতি এবং AI ব্যাখ্যাকে এক মূল্যায়নে আনে।', cards: [{ title: 'স্থানীয় বাজার', text: 'কাছাকাছি চাহিদা ও সরবরাহের সংকেত বুঝুন।' }, { title: 'ব্যবসার সম্ভাব্যতা', text: 'প্রমাণ, সীমাবদ্ধতা, ঝুঁকি ও সুযোগ দেখুন।' }, { title: 'অর্থ পরিকল্পনা', text: 'মার্জিন, প্রকল্প খরচ ও পরিশোধ স্বাচ্ছন্দ্য বুঝুন।' }, { title: 'AI অন্তর্দৃষ্টি', text: 'নির্বাচিত ভাষায় রিপোর্ট সম্পর্কে প্রশ্ন করুন।' }] },
  ...
  mr: {
    header: { tagline: 'स्वतंत्र उद्यम निर्णय सहाय्य', brandAria: 'VyaparSathi ओव्हरव्ह्यूवर जा', language: 'भाषा निवडा', how: 'कसे काम करते', accessibility: 'सुलभता', openMenu: 'नेव्हिगेशन मेनू उघडा', closeMenu: 'नेव्हिगेशन मेनू बंद करा', nav: { overview: 'आढावा', location: 'स्थान', capital: 'भांडवल', business: 'व्यवसाय', market: 'बाजार विश्लेषण', finance: 'वित्त', report: 'पूर्ण अहवाल' } },
    landing: { label: 'ग्रामीण उद्यम निर्णय सहाय्य', title: 'स्थानिक बाजार समजा. वित्ताचे नियोजन करा. आत्मविश्वासाने सुरुवात करा.', text: 'एका मार्गदर्शित सेवेत स्थानिक बाजार, प्रकल्प वित्त आणि सार्वजनिक योजना समजा.', start: 'व्यवसाय मूल्यांकन सुरू करा', proof: ['स्थान', 'व्यवसाय', 'भांडवल', 'व्यवहार्यता आणि वित्त'], aboutTitle: 'हे काय आहे?', aboutText: 'VyaparSathi ही ग्रामीण उद्योजकांसाठी मार्गदर्शित निर्णय-सहाय्य सेवा आहे. ती स्थान, व्यवसाय श्रेणी, वित्त नियोजन, परतफेड तयारी आणि AI स्पष्टीकरण एका मूल्यांकनात आणते.', cards: [{ title: 'स्थानिक बाजार', text: 'जवळची मागणी आणि पुरवठा संकेत समजा.' }, { title: 'व्यवसाय व्यवहार्यता', text: 'पुरावे, मर्यादा, धोके आणि संधी पहा.' }, { title: 'वित्त नियोजन', text: 'मार्जिन, प्रकल्प खर्च आणि परतफेड क्षमता समजा.' }, { title: 'AI अंतर्दृष्टी', text: 'निवडलेल्या भाषेत अहवालाविषयी प्रश्न विचारा.' }] },
  ...
  ta: {
    header: { tagline: 'சுயாதீன தொழில் முடிவு ஆதரவு', brandAria: 'VyaparSathi மேலோட்டத்திற்கு செல்லவும்', language: 'மொழியைத் தேர்ந்தெடுக்கவும்', how: 'இது எப்படி வேலை செய்கிறது', accessibility: 'அணுகல்தன்மை', openMenu: 'வழிசெலுத்தல் மெனுவைத் திறக்கவும்', closeMenu: 'வழிசெலுத்தல் மெனுவை மூடவும்', nav: { overview: 'மேலோட்டம்', location: 'இடம்', capital: 'மூலதனம்', business: 'வணிகம்', market: 'சந்தை பகுப்பாய்வு', finance: 'நிதி', report: 'முழு அறிக்கை' } },
    landing: { label: 'கிராமப்புற தொழில் முடிவு ஆதரவு', title: 'உங்கள் உள்ளூர் சந்தையைப் புரிந்து கொள்ளுங்கள். நிதியைத் திட்டமிடுங்கள். நம்பிக்கையுடன் தொடங்குங்கள்.', text: 'ஒரே வழிகாட்டும் சேவையில் சந்தை, திட்ட நிதி மற்றும் பொதுத் திட்டங்களைப் பாருங்கள்.', start: 'வணிக மதிப்பீட்டைத் தொடங்குங்கள்', proof: ['இடம்', 'வணிகம்', 'மூலதனம்', 'சாத்தியம் மற்றும் நிதி'], aboutTitle: 'இது என்ன?', aboutText: 'VyaparSathi கிராமப்புற தொழில்முனைவோருக்கான வழிகாட்டும் முடிவு-ஆதரவு சேவை. இது இடம், வணிக வகை, நிதி திட்டம், திருப்பிச் செலுத்தும் தயார் நிலை மற்றும் AI விளக்கங்களை ஒரே மதிப்பீட்டில் சேர்க்கிறது.', cards: [{ title: 'உள்ளூர் சந்தை', text: 'அருகிலுள்ள தேவை மற்றும் வழங்கல் சைகைகளைப் புரிந்துகொள்ளுங்கள்.' }, { title: 'வணிக சாத்தியம்', text: 'ஆதாரம், வரம்புகள், அபாயங்கள் மற்றும் வாய்ப்புகள் பார்க்கவும்.' }, { title: 'நிதி திட்டம்', text: 'மார்ஜின், திட்ட செலவு மற்றும் திருப்பிச் செலுத்தும் வசதி புரிந்துகொள்ளுங்கள்.' }, { title: 'AI விளக்கங்கள்', text: 'தேர்ந்தெடுத்த மொழியில் அறிக்கை பற்றி கேளுங்கள்.' }] },
...
function Footer({ locale }: { locale: Locale }) {
  ...
  return <footer className="site-footer"><div><strong>VyaparSathi</strong><span>{copy.advisory}</span></div><nav className="footer-sources" aria-label="Official data and scheme sources"><strong>{copy.sources}</strong><div><a href="https://udyamregistration.gov.in/" target="_blank" rel="noreferrer">MSME Udyam Registration</a><a href="https://msme.gov.in/" target="_blank" rel="noreferrer">Ministry of MSME</a><a href="https://www.data.gov.in/" target="_blank" rel="noreferrer">Open Government Data</a><a href="https://censusindia.gov.in/" target="_blank" rel="noreferrer">Census of India</a><a href="https://kviconline.gov.in/pmegpeportal/" target="_blank" rel="noreferrer">PMEGP portal</a><a href="https://www.mudra.org.in/" target="_blank" rel="noreferrer">Pradhan Mantri MUDRA Yojana</a></div></nav><p>{copy.note}</p></footer>
}
